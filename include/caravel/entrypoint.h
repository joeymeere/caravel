...
/**
 * caravel/entrypoint.h — Input buffer deserialization and entrypoint macros.
 *
 * Parses the raw input buffer that the Solana runtime passes to BPF programs.
 ...
 *
 * Returns CVL_SUCCESS (0) on success.
 */
 ...
 * ```
 *
 * Your handler receives fully deserialized `CvlParameters`
 */
